...
import { IUser } from "../helper/interface";
import { onSignUpValidation } from "../helper/validation";
import { onSubmitSignup } from "../services/auth";
...
const Signup = () => {
  ...
  const onSubmit = (values: IUser, { resetForm }: FormikHelpers<IUser>) => {
    onSubmitSignup(values, resetForm, dispatch, navigate);
  };
          ...
          {({ values, handleChange, errors, handleBlur, touched }) => (
            <Form>
              <div className="text-center md:text-left">
                <label className="mr-1">Welcome</label>
              </div>
